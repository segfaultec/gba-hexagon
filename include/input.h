...
const struct KeyState* __key_state = (struct KeyState*)0x4000130;

static struct KeyState __last_key_state_value;

struct KeyState* __last_key_state = &__last_key_state_value;
